...
const link = Joi.number().optional().example(3).allow(null);
...
exports.updateitem = {
    ...
    start_date: Joi.date().optional(),
    end_date: Joi.date().optional(),
    tags: Joi.array().items(tag).required().allow(null),
    linked_items: Joi.array().items(link).required().allow(null)
};
